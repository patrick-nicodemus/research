...
We follow terminology of \cite{grandisLimitsDoubleCategories1999} and
...
in \cite{grandisLimitsDoubleCategories1999} or \cite{parePersistentDoubleLimits2019}, it is only for the sake of convenience.
...
We refer to \cite{grandisLimitsDoubleCategories1999} for the definition of a lax functor
...
In \cite{grandisLimitsDoubleCategories1999}
...
\end{tikzcd}
  ...
  $\mathbb{E}$ is assumed to be unitary (as in \cite{grandisLimitsDoubleCategories1999}).
\end{definition}
...
\begin{theorem}
  ...
  %   with the splitting being compatible with the source and target
  %   functors.
  \item $\mathbf{H}_0(p)$ and $\mathbf{H}_1(p)$ are locally
    and horizontally split 2-fibrations, with the splitting being
    compatible with the source and target functors.
  \end{itemize}
\end{theorem}
\begin{proof}
  ...
  If $\mathbf{H}_0(p)$ is a 2-fibration that is locally and
  ...
  It is now easy to see that if $\mathbf{H}_0(p)$ is locally and
  ...
  (That is, we must prove 7.2.(i,ii,iii) of \cite{grandisLimitsDoubleCategories1999} for $\overline{F}$.)
...
\end{tikzcd} =
   ...
   Next, we prove that the lax composition cell for $\overline{F}^2$
   is natural with respect to composition (7.2.(i)) of
   \cite{grandisLimitsDoubleCategories1999}.

   Therefore let $u : A \todot B, v :  B \todot C, u' : A'\todot B',
   v' : B'\todot C'$, $a : u \Rightarrow u', b : v\Rightarrow v'$.
   We want to show:
   \begin{equation}
%https://q.uiver.app/#q=
\begin{tikzcd}
	{\overline{F}A} & {\overline{F}A'} & {\overline{F}A'} \\
	{\overline{F}B} & {\overline{F}B'} \\
	{\overline{F}C} & {\overline{F}C'} & {\overline{F}C'}
	\arrow[from=1-1, to=1-2]
	\arrow["{\overline{F}u}"', from=1-1, to=2-1]
	\arrow[equals, from=1-2, to=1-3]
	\arrow["{\overline{F}u'}", from=1-2, to=2-2]
	\arrow["{\overline{F}(u'\cdot v')}", from=1-3, to=3-3]
	\arrow["{\overline{F}a}"{description}, draw=none, from=2-1, to=1-2]
	\arrow[from=2-1, to=2-2]
	\arrow["{\overline{F}v}"', from=2-1, to=3-1]
	\arrow["{\overline{F}v'}", from=2-2, to=3-2]
	\arrow["{\overline{F}b}"{description}, draw=none, from=3-1, to=2-2]
	\arrow[from=3-1, to=3-2]
	\arrow["{\overline{F}^2_{u',v'}}"{description}, draw=none, from=3-2, to=1-3]
	\arrow[equals, from=3-2, to=3-3]
      \end{tikzcd}
      =
      % https://q.uiver.app/#q=
\begin{tikzcd}
	{\overline{F}A} & {\overline{F}A} & {\overline{F}A'} \\
	{\overline{F}B} \\
	{\overline{F}C} & {\overline{F}C'} & {\overline{F}C'}
	...
	\arrow["{\overline{F}(u\cdot v)}"{pos=0.2}, from=1-2, to=3-2]
	\arrow["{\overline{F}(u'\cdot v')}", from=1-3, to=3-3]
	\arrow["{\overline{F}v}"', from=2-1, to=3-1]
	\arrow["{\overline{F}^2_{u,v}}"{description}, draw=none, from=3-1, to=1-2]
	\arrow[equals, from=3-1, to=3-2]
	\arrow["{\overline{F}(a\cdot b)}"{description}, draw=none, from=3-2, to=1-3]
	\arrow[from=3-2, to=3-3]
\end{tikzcd}
   \end{equation}
    Because $\overline{\tau}_{u'\cdot v'}$ is horizontally Cartesian,
    thus monic, it suffices to show both sides are equal after
    composing
    with $\overline{\tau}_{u'\cdot v'}$.
    Unfolding definitions, it suffices to show
    \begin{equation}
      % https://q.uiver.app/#q=
\begin{tikzcd}
	{\overline{F}A} & {\overline{F}A'} & {GA'} & {GA'} \\
	{\overline{F}B} & {\overline{F}B'} & {GB'} \\
	{\overline{F}C} & {\overline{F}C'} & {GC'} & {GC'}
	\arrow[from=1-1, to=1-2]
	\arrow["{\overline{F}u}"', from=1-1, to=2-1]
	\arrow[from=1-2, to=1-3]
	\arrow["{\overline{F}u'}"{pos=0.2}, from=1-2, to=2-2]
	\arrow[equals, from=1-3, to=1-4]
	\arrow["{Gu'}"{pos=0.3}, from=1-3, to=2-3]
	\arrow["{G(u'\cdot v')}", from=1-4, to=3-4]
	\arrow["{\overline{F}a}"{description}, draw=none, from=2-1, to=1-2]
	\arrow[from=2-1, to=2-2]
	\arrow["{\overline{F}v}"', from=2-1, to=3-1]
	\arrow["{\overline{\tau}_{u'}}"{description}, draw=none, from=2-2, to=1-3]
	\arrow[from=2-2, to=2-3]
	\arrow["{\overline{F}v'}"{pos=0.2}, from=2-2, to=3-2]
	\arrow["{Gv'}"{pos=0.3}, from=2-3, to=3-3]
	\arrow["{\overline{F}b}"{description}, draw=none, from=3-1, to=2-2]
	\arrow[from=3-1, to=3-2]
	\arrow["{\overline{\tau}_{v'}}"{description}, draw=none, from=3-2, to=2-3]
	\arrow[from=3-2, to=3-3]
	\arrow["{G^2_{u',v'}}"{description}, draw=none, from=3-3, to=1-4]
	\arrow[equals, from=3-3, to=3-4]
      \end{tikzcd}=
      % https://q.uiver.app/#q=
\begin{tikzcd}
	{\overline{F}A} & {\overline{F}A} & {\overline{F}A'} & {GA'} \\
	{\overline{F}B} \\
	{\overline{F}C} & {\overline{F}C'} & {\overline{F}C'} & {GC'}
	\arrow[equals, from=1-1, to=1-2]
	\arrow["{\overline{F}u}"', from=1-1, to=2-1]
	\arrow[from=1-2, to=1-3]
	\arrow["{\overline{F}(u\cdot v)}"{pos=0.2}, from=1-2, to=3-2]
	\arrow[from=1-3, to=1-4]
	\arrow["{\overline{F}(u'\cdot v')}"{pos=0.2}, from=1-3, to=3-3]
	\arrow["{G(u'\cdot v')}", from=1-4, to=3-4]
	\arrow["{\overline{F}v}"', from=2-1, to=3-1]
	\arrow["{\overline{F}^2_{u,v}}"{description}, draw=none, from=3-1, to=1-2]
	\arrow[equals, from=3-1, to=3-2]
	\arrow["{\overline{F}(b\cdot a)}"{description}, draw=none, from=3-2, to=1-3]
	\arrow[from=3-2, to=3-3]
	\arrow["{\overline{\tau}_{u'\cdot v'}}"{description}, draw=none, from=3-3, to=1-4]
	\arrow[from=3-3, to=3-4]
\end{tikzcd}
\end{equation}
It suffices to prove the equality after composing vertically
with the
2-cells that compose $\overline{\tau}_{b\cdot a}$.
\begin{equation}
  % https://q.uiver.app/#q=
\begin{tikzcd}
	{\overline{F}A} & {\overline{F}A} & GA & {GA'} \\
	{\overline{F}B} \\
	{\overline{F}C} & {\overline{F}C} & GC & {GC'}
	...
	\arrow["{\overline{F}(u\cdot v)}"{pos=0.2}, from=1-2, to=3-2]
	\arrow[from=1-3, to=1-4]
	\arrow["{G(u'\cdot v')}"{pos=0.2}, from=1-3, to=3-3]
	\arrow["{G(u'\cdot v')}", from=1-4, to=3-4]
	\arrow["{\overline{F}v}"', from=2-1, to=3-1]
	\arrow["{\overline{F}^2_{u,v}}"{description}, draw=none, from=3-1, to=1-2]
	\arrow[equals, from=3-1, to=3-2]
	\arrow["{\overline{\tau}_{u\cdot v}}"{description}, draw=none, from=3-2, to=1-3]
	\arrow[from=3-2, to=3-3]
	\arrow["{G(a\cdot b)}"{description}, draw=none, from=3-3, to=1-4]
	\arrow[from=3-3, to=3-4]
\end{tikzcd}
      =
% https://q.uiver.app/#q=
\begin{tikzcd}
	{\overline{F}A} & GA & {GA'} & {GA'} \\
	{\overline{F}B} & GB & {GB'} \\
	{\overline{F}C} & GC & {GC'} & {GC'}
	\arrow[from=1-1, to=1-2]
	\arrow["{\overline{F}u}"', from=1-1, to=2-1]
	\arrow[from=1-2, to=1-3]
	\arrow["Gu"{pos=0.2}, from=1-2, to=2-2]
	\arrow[equals, from=1-3, to=1-4]
	\arrow["{Gu'}"{pos=0.3}, from=1-3, to=2-3]
	\arrow["{G(u'\cdot v')}", from=1-4, to=3-4]
	\arrow["{\overline{\tau}_u}"{description}, draw=none, from=2-1, to=1-2]
	\arrow[from=2-1, to=2-2]
	\arrow["{\overline{F}v}"', from=2-1, to=3-1]
	\arrow["Ga"{description}, draw=none, from=2-2, to=1-3]
	\arrow[from=2-2, to=2-3]
	\arrow["Gv"{pos=0.2}, from=2-2, to=3-2]
	\arrow["{Gv'}"{pos=0.3}, from=2-3, to=3-3]
	\arrow["{\overline{\tau}_v}"{description}, draw=none, from=3-1, to=2-2]
	\arrow[from=3-1, to=3-2]
	\arrow["Gb"{description}, draw=none, from=3-2, to=2-3]
	\arrow[from=3-2, to=3-3]
	\arrow["{G^2_{u',v'}}"{description}, draw=none, from=3-3, to=1-4]
	\arrow[equals, from=3-3, to=3-4]
      \end{tikzcd}
    \end{equation}
      Applying naturality of $G^2$ and the definition of
      $\overline{F}^{2}$,
      we get the desired result.

      The proof for the compatibility of the associator is similar.
      We use the fact that $\overline{\tau}_{u(vw)}$ is horizontally
      monic to reduce the condition for $\overline{F}$ to the analogous
      condition for $G$. We use the naturality of the associator
      for the double category and repeatedly unfold the definitions
      for $\overline{F}^2$.

      We conclude that $\overline{F}$ is a lax functor.

      We remark that $\overline{\tau}$ is
      obviously pseudonatural by construction;
      the coherence conditions 7.3.lht1, 7.3.lht2
      and 7.3.lht3 of 
      \cite{grandisLimitsDoubleCategories1999}
      are all immediate by
      construction of $\overline{F}^0$ and $\overline{F}^2$
      and $\overline{\tau}$.

\textbf{Now let us prove that} $\overline{\tau}$ is
\textbf{Cartesian}.

In fact, the only properties that we will need of $\overline{\tau}$
are that:
\begin{itemize}
\item for an object $A$ in $\mathbb{A}$, the 1-cell
  $\overline{\tau}_A$
  is Cartesian
\item for a vertical morphism $u : A\todot B$ in $\mathbb{A}$, the 2-cell
  $\overline{\tau}_u$ is horizontally Cartesian
\item $\overline{\tau}$ is strict, or
  $\mathbf{H}_0(p):\mathbf{H}_0(\mathbb{E})\to
  \mathbf{H}_0(\mathbb{B})$ is a 2-categorical fibration,
  and
  for a horizontal morphism $f : A\to B$,
  the 2-cell $\overline{\tau}_f$ (the ``pseudo'' cell) is vertically
  Cartesian, i.e., Cartesian with respect to the local
  Hom functors of $\mathbf{V}_0(p): \mathbf{V}_0(\mathbb{E})\to \mathbf{V}_0(\mathbb{B})$.
\end{itemize}

Therefore, this establishes a characterization of the pseudonatural
transformations
which are Cartesian with respect to
$p : \mathbf{Lax}(\mathbb{A},\mathbb{E}) \to
\mathbf{Lax}(\mathbb{A},\mathbb{B})$.

Therefore, introduce a pseudofunctor
$H : \mathbb{A} \to \mathbb{E}$, and pseudonatural transformations
$\sigma : pH \Rightarrow F, \rho : H\Rightarrow G$ with the property
that
$\tau\circ\sigma = p\rho$. We will prove that there is a unique
pseudonatural transformation $\hat{\sigma} : H\Rightarrow
\overline{F}$ such that $\overline{\tau}\circ\hat{\sigma}=\rho$.

The definition of $\hat{\sigma}$ on objects and on vertical 1-cells
should be evident; the proof here proceeds as in the 1-categorical
case. That is:
\begin{itemize}
\item for $A$ in $\mathbb{A}$, $\hat{\sigma}_{A} : HA\to
  \overline{F}A$ is the unique 1-cell such that
  $p(\hat{\sigma}_A)=\sigma_A$
  and $\overline{\tau}_{A}\circ \hat{\sigma}_A = \rho_{A}$.
\item for $u : A \todot B$ in $\mathbb{A}$, $\hat{\sigma}_{u} : HA\to
  \overline{F}A$ is the unique 2-cell such that
  $p(\hat{\sigma}_u)=\sigma_u$
  and $\overline{\tau}_u\circ \hat{\sigma}_u = \rho_u$.
\end{itemize}

Now, for $f : A\to A'$, $\overline{\tau}_f$ is either
the identity if $\tau$ is strict, or it is vertically Cartesian if
$p$ is a 2-categorical fibration; in either case, the pasting with
the vertical cell $e_{\sigma f}$ is vertically Cartesian.
Furthermore,  since $\overline{\tau}_{a'}$ is horizontally Cartesian,
so is the vertical 2-cell $e_{\overline{\tau}_{a'}}$.

Therefore, $\rho_f$ factors as the 
pasting of $\overline{\tau}_f$ with a unique cell $\hat{\sigma}_f$
lying over $\sigma_f$.

\textbf{Now we prove that $\sigma$ is pseudonatural.}
We consider each of the axioms of
\cite{parePersistentDoubleLimits2019}
in turn.

\begin{itemize}
\item 3.2.pht1 - pseudonaturality on a cell - postcompose on the right with
  $\overline{\tau}_v$ and paste $\overline{\tau}_j$ below.
  $\overline{\tau}_v$ is horizontally monic (as it is horizontally
  Cartesian)
  and $\overline{\tau}_j$ is an invertible 2-cell.
  This allows us to reduce to the analogous axiom for $\rho$.
\end{itemize}
To see that $\sigma$ is pseudonatural
\end{proof}
...
Grandis and Pare have given \cite{grandisLimitsDoubleCategories1999} a definition
