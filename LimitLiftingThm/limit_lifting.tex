...
bicategories. We refer to \cite{parePersistentDoubleLimits2019}
...
\begin{definition}[Globular Modification]
  ...
  Let $H, K : F\Rightarrow G$ be horizontal natural transformations.
  A \textbf{modification} $\sigma : H\Rightarrow K$ associates
...
\begin{theorem}
  ...
  of lax functors, pseudonatural horizontal transformations,
...
%   horizontal pseudonatural transformations, and a horizontal
...
\label{eq:19} is equivalent to the condition that $\gamma$ satisfies
